              ...
              <div>
                ...
                <p v-for="(msg, index) in list.list" :key="index" :class="{'right':msg.type=='my' }"
                  ...
                  <el-avatar v-if="msg.type=='user'"
                             shape="circle"
                             src="src/assets/userAvata.png" style="background-color: white"></el-avatar>
                  <el-avatar v-if="msg.type=='my'" shape="circle"
                             src="src/assets/userAvatar.png" style="float:right;"></el-avatar>
                  <!--                <span class="content" style="display: inline-block;-->
                  <!--                                          width:auto;-->
                  ...
                  <!--                              ">-->
                  <!--                                              {{ msg.msg }}</span>-->
                  <!--                <span v-html="marked.parse(msg.msg)" class="markdown-body"></span>-->

                  <el-text class="mx-1"
                           style="padding:0 10px; border-radius: 10px; display: inline-block;background-color: #D2F9D1"
                           tag="span"
...
const handleSSESubmit = async () => {
  ...
  eventSource.onmessage = function(event) {
    msgList.value[0].list[msgList.value[0].list.length - 1].msg = msgList.value[0].list[msgList.value[0].list.length - 1].msg + event.data;
  };
